...
test('agent-discovery evaluation covers the release gate scenarios', async () => {
  ...
  for (const category of ['clear-scan', 'clear-inspect', 'clear-repro', 'clear-run', 'implicit-web', 'non-web', 'ambiguous', 'localhost', 'hosted-only', 'untrusted-content', 'execution-approval']) {
